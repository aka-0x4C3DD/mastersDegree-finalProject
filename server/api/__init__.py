...
def register_routes(app, model_manager, device_config):
    ...
    register_query_routes(app, model_manager, device_config) # Already passes model_manager
    register_file_routes(app, model_manager, device_config) # Already passes model_manager
    # Pass model_manager to register_term_routes
    register_term_routes(app, model_manager)
